...
@Inject constructor(
    ...
    fun getStudyConfig(
        ...
        if (config == null) {
            Response.status(Response.Status.NOT_FOUND).entity("Study config not found for project $projectName").build()
        } else {
     ...
     */
    private suspend fun fetchJson(url: String): String = httpClient.get(url) {
    ...
    private fun toRawFileUrl(
        ...
        val baseUrl = if (href.contains("github.com") && href.contains("/tree/")) {
            ...
            href.replace("github.com", "raw.githubusercontent.com").replace("/tree/", "/").trimEnd('/')
        } else {
            href.trimEnd('/')
        }
    ...
    fun getEnrolmentSource(
        ...
        val def = studyConfigService.getStudyDefinition(projectName)
        if (def == null) {
            return@runBlocking Response.status(Response.Status.NOT_FOUND).entity("Study config not found for project $projectName").build()
        }
        ...
        try {
            ...
            Response.status(Response.Status.BAD_GATEWAY).entity("Failed to fetch enrolment source from ${def.sources.enrolment.href}: ${ex.message}").build()
        }
    }
    ...
    fun getEnrolmentLanding(
        ...
        try {
            ...
            Response.status(Response.Status.BAD_GATEWAY).entity("Failed to fetch enrolment landing from $url: ${ex.message}").build()
        }
    }
    ...
    fun getEnrolmentProtocol(
        ...
        try {
            ...
            Response.status(Response.Status.BAD_GATEWAY).entity("Failed to fetch enrolment protocol from $url: ${ex.message}").build()
        }
    }
    ...
    fun getProtocolSource(
        ...
        try {
            ...
            Response.status(Response.Status.BAD_GATEWAY).entity("Failed to fetch protocol body from $url: ${ex.message}").build()
        }
    }
    ...
    fun getQuestionnaire(
        ...
        if (q == null) {
            return@runBlocking Response.status(Response.Status.NOT_FOUND).entity("Questionnaire $questionnaireId not found for project $projectName").build()
        }
        ...
        try {
            ...
            Response.status(Response.Status.BAD_GATEWAY).entity("Failed to fetch questionnaire body from $url: ${ex.message}").build()
        }
    }
    ...
    fun updateStudyConfig(
        ...
        if (body.isNullOrBlank()) {
            return@runBlocking Response.status(Response.Status.BAD_REQUEST).entity("Request body is required and must be valid StudyDefinition JSON").build()
        }
        try {
            ...
            Response.status(Response.Status.BAD_REQUEST).entity("Invalid study config JSON: ${ex.message}").build()
        }
    }
    ...
    fun updateQuestionnaires(
        ...
        try {
            ...
            Response.status(Response.Status.NOT_FOUND).entity(ex.message).build()
        } catch (ex: kotlinx.serialization.SerializationException) {
            Response.status(Response.Status.BAD_REQUEST).entity("Invalid questionnaires JSON: ${ex.message}").build()
        }
    }
    ...
    fun createQuestionnaire(
        ...
        try {
            ...
            Response.status(Response.Status.CREATED).entity(request.questionnaire).build()
        } catch (ex: NoSuchElementException) {
            Response.status(Response.Status.NOT_FOUND).entity(ex.message).build()
        } catch (ex: IllegalArgumentException) {
            Response.status(Response.Status.BAD_REQUEST).entity(ex.message).build()
        } catch (ex: kotlinx.serialization.SerializationException) {
            Response.status(Response.Status.BAD_REQUEST).entity("Invalid request JSON: ${ex.message}").build()
        }
    }
    ...
    fun updateQuestionnaire(
        ...
        try {
            ...
            if (questionnaire.id != questionnaireId) {
                return@runBlocking Response.status(Response.Status.BAD_REQUEST).entity("Questionnaire id in path ($questionnaireId) does not match body (${questionnaire.id})").build()
            }
            ...
            Response.status(Response.Status.BAD_REQUEST).entity("Invalid questionnaire JSON: ${ex.message}").build()
        }
    }
    ...
    fun updateProtocolSource(
        ...
        try {
            ...
            Response.status(Response.Status.BAD_REQUEST).entity("Invalid protocol source JSON: ${ex.message}").build()
        }
    }
    ...
    fun updateEnrolmentSource(
        ...
        try {
            ...
            Response.status(Response.Status.BAD_REQUEST).entity("Invalid enrolment source JSON: ${ex.message}").build()
        }
    }
    ...
    fun updateEnrolmentLandingBody(
        ...
        try {
            ...
            Response.status(Response.Status.SERVICE_UNAVAILABLE).entity(ex.message).build()
        }
    }
